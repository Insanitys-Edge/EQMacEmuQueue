...
RULE_INT(World, TestPopulationOffset, 0, "Testing only: Add this number to actual population for queue testing (0 = disabled)")
RULE_BOOL(World, QueueBypassGMLevel, true, "Allow GMs (status >= 80) to bypass the queue")
RULE_INT(World, QueueEstimatedWaitPerPlayer, 60, "Estimated wait time in seconds per player ahead in queue")
